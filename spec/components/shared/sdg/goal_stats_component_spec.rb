...
describe Shared::SDG::GoalStatsComponent, type: :component do
  let(:component) { Shared::SDG::GoalStatsComponent.new(goal: goal) }
  ...
  it "shows goal stats" do
    ...
    expect(page).to have_text "Approved budget $2,000"
  end
end
